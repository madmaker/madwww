...
class uEvents_events_file {
    ...
    public function text($str) {
        return $this->uCore->text(array('uEvents','events_file'),$str);
    }
    ...
    private function get_file() {
        ...
        if($this->thumb) {
            $this->file_addr= $_SERVER['DOCUMENT_ROOT'].'/'.$this->uCore->mod.'/events_files/'.site_id.'/'.$file->event_id.'/'.$this->file_id.'/'.$this->file_id.'_sm.jpg';
            $this->file_mime='image/jpeg';
            $this->file_name='thumb_'.$file->file_name;
        }
        else {
            $this->file_addr= $_SERVER['DOCUMENT_ROOT'].'/'.$this->uCore->mod.'/events_files/'.site_id.'/'.$file->event_id.'/'.$this->file_id.'/'.$file->file_name_hash;
