...
class flip_book{
    ...
    public function copy_el($cols_els_id,$new_col_id,$el,$source_site_id=site_id,$dest_site_id=0) {
        ...
        //attach art to col
        $this->uPage->create_el($cols_els_id,$new_col_id,'flip_book',$el->el_pos,$el->el_style,$new_el_id,$dest_site_id);
    ...
    public function attach_el2col($el_id,$col_id) {
        ...
        try {
            ...
            /** @noinspection PhpUndefinedMethodInspection */
            if(!$stm->fetch(PDO::FETCH_OBJ)) $this->uFunc->error("uPage_elements_flip_book_common 10");
        }
        catch(PDOException $e) {$this->uFunc->error('uPage_elements_flip_book_common 20'/*.$e->getMessage()*/);}
        ...
        //attach art to col
        $res=$this->uPage->add_el2db($cols_els_id,$el_pos,'flip_book',$col_id,$el_id);
